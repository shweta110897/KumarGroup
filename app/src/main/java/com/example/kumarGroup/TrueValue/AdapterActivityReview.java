...
public class AdapterActivityReview extends RecyclerView.Adapter<AdapterActivityReview.viewHolder> implements Filterable {

    Context context;
    ArrayList<ActivityData> mcatlist;
    ArrayList<ActivityData> mcatlist_one;
    ...
    public AdapterActivityReview(Context context, Activity activity , ArrayList<ActivityData> mcatlist) {
...
//        holder.hot_cold_harm.setVisibility(View.GONE);
        ...
        holder.tv_mobile_no_show_rc_gv_other.setText("Other Mobile: "+mcatlist.get(position).getOtherMobile());
//         holder.tv_Whapp_Number_show_rc_gv.setText("WhatsApp Number: "+mcatlist.get(position).getWhatsappno());
        ...
        holder.model_added.setText(mcatlist.get(position).getModelTName());
        holder.tv_district_show_rc_gv.setText(mcatlist.get(position).getDescription());
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ActivityData> filteredList = new ArrayList<>();

                    for (ActivityData row : mcatlist_one) {
...
*/
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mcatlist = (ArrayList<ActivityData>) filterResults.values;
    ...
    public interface RecyclerViewItemInterface {
        ...
        void onItemClick(int position,ArrayList<ActivityData> mcatlist);
        void onCallclick(int position,ArrayList<ActivityData> mcatlist);
