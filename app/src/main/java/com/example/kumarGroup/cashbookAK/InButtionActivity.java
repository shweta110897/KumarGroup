...
public class InButtionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_buttion);
        ...
        indate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(InButtionActivity.this,
        ...
        select_mode_cash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                select_mode_cash.setBackgroundResource(R.drawable.cash_bank_round_file);
                cashfalg = 1;
                bankflag = 0;
            }
        });
        ...
        select_mode_bank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                select_mode_bank.setBackgroundResource(R.drawable.cash_bank_round_file);
                cashfalg = 0;
                bankflag = 1;
            }
        });
        ...
        save_inbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog= new ProgressDialog(InButtionActivity.this);
                progressDialog.show();
                ...
                if (TextUtils.isEmpty(in_amount.getText().toString().trim()) && "".equals(in_amount.getText().toString().trim())){
                    ...
                    Utils.showErrorToast(InButtionActivity.this,"Enter amount");
                    return;
                }
                if (TextUtils.isEmpty(descripin_cash.getText().toString().trim()) && "".equals(descripin_cash.getText().toString().trim())){
                    progressDialog.dismiss();
                    Utils.showErrorToast(InButtionActivity.this,"Enter Description");
                    return;
                }
                if (TextUtils.isEmpty(indate.getText().toString().trim()) && "".equals(indate.getText().toString().trim())){
                    progressDialog.dismiss();
                    Utils.showErrorToast(InButtionActivity.this,"Select a date");
                    return;
                }

                if (cashfalg == 0 && bankflag == 0){
                    progressDialog.dismiss();
                    Utils.showErrorToast(InButtionActivity.this,"Please select Payment mode");
                    return;
                }
                else {
                    if (cashfalg == 1){
               ...
               String emp_id = sp.getString("emp_id", "");
                ...
                WebService.getClient().cashbook_send_inbutton_data_web(
                        ...
                        RequestBody.create(MediaType.parse("text/plain"), "IN"),
                    ...
                    public void onResponse(@NotNull Call<cashbook_inButton_model> call,
                        ...
                        Toast.makeText(InButtionActivity.this, ""+response.body().getMsg(), Toast.LENGTH_SHORT).show();


                        //   Toast.makeText(DeliveryButtonActivity.this,"response id "+response.body().getId() , Toast.LENGTH_SHORT).show();
                        Intent i = new Intent(InButtionActivity.this, CashbookDashboard.class);
                        startActivity(i);
                        finish();
                    ...
                    public void onFailure(@NotNull Call<cashbook_inButton_model> call, @NotNull Throwable t) {
                        progressDialog.dismiss();
                        Toast.makeText(InButtionActivity.this, ""+t.getCause(), Toast.LENGTH_SHORT).show();
