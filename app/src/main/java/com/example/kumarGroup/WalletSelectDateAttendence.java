...
public class WalletSelectDateAttendence extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallet_select_date_attendence);


        getSupportActionBar().setTitle("Attandance");
        ...
        EdtWalletSalarySlipDateOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(WalletSelectDateAttendence.this, R.style.TimePickerTheme, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        btnWalletSalarySlip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WalletSelectDateAttendence.this, WalletAttendance.class);
