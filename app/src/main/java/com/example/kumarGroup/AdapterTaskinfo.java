...
public class AdapterTaskinfo extends RecyclerView.Adapter<AdapterTaskinfo.ViewHolder> {
    ...
    private CallItemInterface callItemInterface;


    public AdapterTaskinfo(List<DataTask> listTask, Activity activity) {
    ...
    public void setViewItemInterface(CallItemInterface callItemInterface) {
        this.callItemInterface = callItemInterface;
    }

    @NonNull
    @Override
    public AdapterTaskinfo.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View listItem = inflater.inflate(R.layout.activity_adapter_taskinfo, parent, false);
        AdapterTaskinfo.ViewHolder viewHolder = new AdapterTaskinfo.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterTaskinfo.ViewHolder holder, @SuppressLint("RecyclerView") int position) {

        sp1 = activity.getSharedPreferences("Login", MODE_PRIVATE);
        emp = sp1.getString("emp_id", "");
        //Toast.makeText(context, "emp"+emp, Toast.LENGTH_SHORT).show();

        if (listTask.get(position).getTask().contains("Call")) {
            holder.tv_Customer_name.setText(listTask.get(position).getTask_take_name());
            Log.d("nsme", "onBindViewHolder: " + listTask.get(position).getTask_take_name());
                ...
                public void onClick(View view) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            Log.d("cat_id", "replaceNumber: " + listTask.get(position).getCat_id());
                            Log.d("call_id", "replaceNumber: " + listTask.get(position).getCall_id());
                            ...
                            WebService.getClient().getreplacenumber(emp,
                               ...
                               /* holder.tv_Customer_name.setText(response.body().getTask().get(0).getTask_take_name());
                                ...
                                //reaplace = response.body().getTask().get(position).getMobileno();
                                Log.d("Replace", "onResponse: "+reaplace);

                                holder.lin_callcustomer.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent intent = new Intent(Intent.ACTION_CALL);
                                        intent.setData(Uri.parse("tel:+91" + reaplace));
            ...
            holder.lin_callcustomer.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.d("SPCallLog", "onClick: " + listTask.get(position).getMobile());
                    ...
                    if (!utils.userPermission.checkCallPermission()) {
                        ...
                        Intent intent = new Intent(Intent.ACTION_CALL);
//                        intent.setData(Uri.parse("tel:+91" + "9638583611"));
                        ...
                        if (callItemInterface != null) {
                            callItemInterface.onItemClick(holder.getAdapterPosition(),listTask.get(position).getCall_id());
                        }
//                        activity.finish();
...
//                        context.registerReceiver(receiver, intent);
                ...
                public void onClick(View view) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                           ...
                           /* Toast.makeText(context, ""+emp+
                                    "cid"+listTask.get(position).getCat_id()
                                    +"Call"+listTask.get(position).getCall_id(), Toast.LENGTH_LONG).show();*/
                            ...
                            WebService.getClient().getreplacenumber(emp,
                                ...
                                public void onResponse(@NotNull Call<DataReaplceModel> call, @NotNull Response<DataReaplceModel> response) {
                                   ...
                                   /* Toast.makeText(context, ""+emp+
                                            "cid"+listTask.get(position).getCat_id()
                                            +"Call"+listTask.get(position).getCall_id(), Toast.LENGTH_LONG).show();
                                    Toast.makeText(context, ""+response.body().getTask().get(0).getTask_take_name()
                                            +" "+response.body().getTask().get(0).getWhatsappno()
                                            +" "+response.body().getTask().get(0).getVilage(),
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            // this.btn_nexttask=itemView.findViewById(R.id.btn_nexttask);
        }
    }

/*    private void replaceNumber(final String call_id){
//        sp = this.context.getSharedPreferences("Login",Context.MODE_PRIVATE);
//               // getSharedPreferences("Login",MODE_PRIVATE);
//        emp=sp.getString("emp_id","");
//        Log.d("empid", "replaceNumber: "+emp);
        WebService.getClient().getreplacenumber(emp,"2","3").enqueue(new Callback<DataReaplceModel>() {
            @Override
            public void onResponse(@NotNull Call<DataReaplceModel> call, @NotNull Response<DataReaplceModel> response) {
    ...
    public interface CallItemInterface {

        void onItemClick(int position, String callId);
