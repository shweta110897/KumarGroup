...
public class ViewInvoiceNewAdapter extends RecyclerView.Adapter<ViewInvoiceNewAdapter.ViewHolder> {

    Context context;
    List<DataViewInvoice> dataViewInvoiceList;

    public ViewInvoiceNewAdapter(Context context, List<DataViewInvoice> dataViewInvoiceList) {
    ...
    @NonNull
    @Override
    public ViewInvoiceNewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View listItem = inflater.inflate(R.layout.view_invoice_raw, parent, false);
        ViewInvoiceNewAdapter.ViewHolder viewHolder = new ViewInvoiceNewAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull ViewInvoiceNewAdapter.ViewHolder holder, int position) {
        ...
        String PartTot = dataViewInvoiceList.get(position).getTotalprice();
        ...
        holder.tv_Laber_Total.setText(dataViewInvoiceList.get(position).getLaber_charge());
