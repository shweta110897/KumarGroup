...
public class DealstageHistoryActivityViewINQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dealstage_history_view_inq);

        getSupportActionBar().setTitle("Deal Stage History View Inquiry");
        ...
        WebService.getClient().dealstage_history_web(sname).enqueue(new Callback<deal_stage_history_model>() {
            ...
            public void onFailure(Call<deal_stage_history_model> call, Throwable t) {
                Utils.showErrorToast(DealstageHistoryActivityViewINQ.this,t.getMessage());
            }
        });
