...
public class PriceDetailsAddDealstageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_AddPriceD_Price.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                Log.d("sequence", String.valueOf(s));
                ...
                if (String.valueOf(s).equals("")){
                    ...
                    String numToWord = NumToWordDealstage.GFG.convertToWords(number);
        ...
        btn_AddPriceDetails_Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isvalidate1()){
                    progressDialog = new ProgressDialog(PriceDetailsAddDealstageActivity.this);
                    progressDialog.show();
                    ...
                    WebService.getClient().getPriceDetailNext(edt_AddPriceD_Price.getText().toString(),
                        ...
                        public void onResponse(Call<PriceDetailNextModel> call, Response<PriceDetailNextModel> response) {
                            ...
                            Toast.makeText(PriceDetailsAddDealstageActivity.this, ""+response.body().getMsg(), Toast.LENGTH_SHORT).show();

                            // Intent i = new Intent(PriceDetailsAddActivity.this, RtoDetailsActivity.class);
                            Intent i = new Intent(PriceDetailsAddDealstageActivity.this, AddCustomerDetailsDealstageActivity.class);
    ...
    private boolean isvalidate1() {
        if (edt_AddPriceD_Price.getText().toString().equals("")){
            Utils.showErrorToast(PriceDetailsAddDealstageActivity.this, "Please enter price");
            return false;
