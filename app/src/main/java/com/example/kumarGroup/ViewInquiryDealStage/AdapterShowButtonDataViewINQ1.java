...
import com.example.kumarGroup.DealstageAK.AdapterNotesDealStage;
...
public class AdapterShowButtonDataViewINQ1 extends RecyclerView.Adapter<AdapterShowButtonDataViewINQ1.viewHolder> implements Filterable {
    ...
    public AdapterShowButtonDataViewINQ1(Context context, Activity activity , List<Catnotattend> mcatlist) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (DealstageRecyclerActivityViewINQ1.overandnew_negotiaion && "Dealer Meeting".equals(mcatlist.get(position).getInq_new()) || "Dealer Meeting".equals(mcatlist.get(position).getInq_overdue()))
        {

            if (DealstageRecyclerActivityViewINQ1.overandnew_followup || DealstageRecyclerActivityViewINQ1.overandnew_negotiaion){
        ...
        if (DealstageRecyclerActivityViewINQ1.deal_sell_lost_Inquiry_flag  || DealstageRecyclerActivityViewINQ1.deal_dropInquiry_flag){
            holder.iv_edit.setVisibility(View.GONE);

        }

        if (DealstageRecyclerActivityViewINQ1.notattend_flag_sms_call_what) {
        ...
        if (DealstageRecyclerActivityViewINQ1.deal_overDue_flag_other){
        ...
        if (DealstageRecyclerActivityViewINQ1.deal_sell_lost_Inquiry_flag_other){
            holder.design_deal.setVisibility(View.GONE);
            holder.txtdeal.setVisibility(View.GONE);
        ...
        if (DealstageRecyclerActivityViewINQ1.deal_deliveryInquiry_flag_showonly_attachbutton) {
            holder.remider.setVisibility(View.GONE);
            holder.design_deal.setVisibility(View.GONE);
            holder.txtremider.setVisibility(View.GONE);
            holder.txtdeal.setVisibility(View.GONE);
        ...
        holder.tv_mobile_no_show_rc_gv_other.setText("Other Mobile: "+mcatlist.get(position).getWhatsappno());
        ...
        holder.payment_type.setText("Payment Type: "+mcatlist.get(position).getPayment_type());
        /*passing_type*/
        holder.passing_type.setText(mcatlist.get(position).getPassing_type());
        holder.tv_regno.setText(mcatlist.get(position).getPassing_type());
                ...
                if (!utils.userPermission.checkCallPermission()) {
                    ...
                    if (DealstageRecyclerActivityViewINQ1.notattend_flag_sms_call_what) {
                        ...
                        WebService.getClient().getMyInqProfile_CSW(emp,
                            ...
                            @Override
                            public void onResponse(@NotNull Call<myInqCswModel> call, @NotNull Response<myInqCswModel> response) {
                                Log.d("Call", "onResponseElse: notattend" + response.body().getMsg());
        ...
        holder.remider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (DealstageRecyclerActivityViewINQ1.deal_NegotiationandfinalInquiry_flag_other  ||DealstageRecyclerActivityViewINQ1.deal_followup_Inquiry_other
                    ...
                    i.putExtra("cur_stage", mcatlist.get(position).getFollow_up_type());
        ...
        if (DealstageRecyclerActivityViewINQ1.Not_attend_skip_check){
    ...
    public class viewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tv_name_show_rc_gv,tv_category_it_show_rc_gv,tv_mobile_no_show_rc_gv,tv_regno,cust_name,remind_date,
