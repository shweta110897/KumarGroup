...
public class CustomerSkimDealstageActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (consumer_Skim1.equals("Yes")) {
                    if (edt_CustomerSkim_Description.getText().length() == 0) {
                        Toast.makeText(CustomerSkimDealstageActivity.this, "Enter Data", Toast.LENGTH_SHORT).show();
                ...
                if (check1 && check2 && check3) {
                    ...
                    WebService.getClient().getConsumerSkimSubmit(
                        ...
                        public void onResponse(@NotNull Call<ConsumerSkimSubmitModel> call, Response<ConsumerSkimSubmitModel> response) {
                            ...
                            Toast.makeText(CustomerSkimDealstageActivity.this, "" + response.body().getMsg(), Toast.LENGTH_SHORT).show();
                            Log.d("TAG", "onFailure: checkdata fail " + response.body().getMsg());

                            Intent i = new Intent(CustomerSkimDealstageActivity.this, DealfirstMeetingActivityViewINQ.class);
                            startActivity(i);
                    ...
                    Toast.makeText(CustomerSkimDealstageActivity.this, "Check Your Data Again", Toast.LENGTH_SHORT).show();
                }
