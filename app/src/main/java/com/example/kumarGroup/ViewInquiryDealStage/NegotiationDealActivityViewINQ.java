...
public class NegotiationDealActivityViewINQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pro = new ProgressDialog(NegotiationDealActivityViewINQ.this);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if( Negotiation_list[position]=="Negotiation"){
                    ...
                    if ("Reminder".equals(store_spinnersData)){
                        ...
                        Intent i = new Intent(NegotiationDealActivityViewINQ.this, DealFormGeneralActivityViewINQ.class);
        ...
        submit_ne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("Negotiation".equals(store_spinnersData)){
                    Utils.showErrorToast(NegotiationDealActivityViewINQ.this,"Please select");
                    return;
                }
                ...
                WebService.getClient().dealstage_negoatioaion_web(autoid,store_spinnersData).enqueue(new Callback<deal_negoatiation_web>() {
                    ...
                    public void onResponse(Call<deal_negoatiation_web> call, Response<deal_negoatiation_web> response) {
                        pro.dismiss();
                        startActivity(new Intent(NegotiationDealActivityViewINQ.this, DealViewMainActivity.class));
                        finish();
                    }
                    ...
                    public void onFailure(Call<deal_negoatiation_web> call, Throwable t) {
                        pro.dismiss();
                        Utils.showErrorToast(NegotiationDealActivityViewINQ.this,t.getMessage());
                    }
                });
            }
        });
