...
public class DealViewMainActivityNegotiation extends AppCompatActivity {

    //View InquiryPaymentType

    String emp_id,catId_eid,catId_list,VillageId="",ModelName="",ProductName,catID,villageIdFrag,DealType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deal_view_main_negotiation);


        getSupportActionBar().setTitle("Deal Stage View Inquiry Negotiation");
...
//                showDialogPayment();
        ...
        deal_common_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DealViewMainActivityNegotiation.this, CommonSearchActivity1.class);
        ...
        deal_feedback_call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DealViewMainActivityNegotiation.this, FeedbackCallActivity.class);
                intent.putExtra("VillageId",VillageId);
        ...
        deal_perfomance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(DealViewMainActivityNegotiation.this,DeliveryButtonActivity.class)
                        .putExtra("VillageId",VillageId)
                        .putExtra("Maker",Maker)
                        .putExtra("Model",Model)
                        .putExtra("MFGYear",MFGYear)
                        .putExtra("model",ModelName).putExtra("Paymenttype",Paymenttype)   .putExtra("DealType",DealType)
        ...
        deal_followup_Inquiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(DealViewMainActivityNegotiation.this,DealstageRecyclerActivityViewINQ1.class)
        ...
        deal_DealerMeeting_Inquiry.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(DealViewMainActivityNegotiation.this,DealstageRecyclerActivityViewINQ1.class)
                            ...
                            .putExtra("Model",Model)
                            .putExtra("MFGYear",MFGYear)
                            .putExtra("Passingtype",Passingtype)   .putExtra("DealType",DealType));
                }
            });
        ...
        deal_deliveryInquiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // DealstageRecyclerActivityViewINQ1.deal_deliveryInquiry_flag = true;
                startActivity(new Intent(DealViewMainActivityNegotiation.this, DeliveryButtonActivityINQ.class).putExtra("VillageId",VillageId)
                        .putExtra("model",ModelName).putExtra("Paymenttype",Paymenttype)
                        .putExtra("DealType",DealType)
                        .putExtra("Maker",Maker)
                        .putExtra("Model",Model)
...
//                            ModelID.add(response.body().getData().get(i).getId());
    ...
    private void showDialogModelVillage() {
        ...
        dialog1 = new Dialog(DealViewMainActivityNegotiation.this);
    ...
    private void showDialogPayment() {
        dialog = new Dialog(DealViewMainActivityNegotiation.this);
...
//        setupViewPager(viewPager2);
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Passing Type"));
...
//        modelname_list = new ArrayList<>();
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                  Intent intent = new Intent(DealViewMainActivityNegotiation.this, CommonSearchActivity.class);
                    intent.putExtra("Paymenttype",Paymenttype);
                    startActivity(intent);
            }
        });
    ...
    public void setCountMethod(String villageId, String modelName,String Paymenttype1,String PassingType1,String DealType1,String Maker1,String Model1,String MFGYear1) {
        ModelName=modelName;
...
//                deal_feedbackcall_count.setText(response.body());
            ...
            public void onFailure(Call<deal_set_count_model> call, Throwable t) {
                Utils.showErrorToast(DealViewMainActivityNegotiation.this,t.getMessage());
            }
        });
    }
            ...
            public void onResponse(Call<DataVillageeModel123> call, @NonNull Response<DataVillageeModel123> response1) {
                ...
                if (response1.isSuccessful()) {
                    if (response1.body() != null) {
                        ...
                        AutoCmpleteAdapter adapter = new AutoCmpleteAdapter(DealViewMainActivityNegotiation.this,   response1.body().getVillage());
    ...
    public  void setData(String villagname){

        Log.e("searchtestx", villagname);
