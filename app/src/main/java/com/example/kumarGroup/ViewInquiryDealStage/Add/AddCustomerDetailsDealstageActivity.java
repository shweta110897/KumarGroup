...
import com.example.kumarGroup.ViewInquiryDealStage.DealfirstMeetingActivityViewINQ;
...
public class AddCustomerDetailsDealstageActivity extends AppCompatActivity {
    ...
    Spinner spn_AddCD_State, spn_AddCD_city, spn_AddCD_Distric,
            spn_AddCD_Taluko, spn_AddCD_Village;
      ...
      /*  img_AddCD_BankPassBook = findViewById(R.id.img_AddCD_BankPassBook);
       ...
       // if(Product_Name.equals("Implement") || Product_Name.equals("Spar part")){
        if(Product_Name.equals("Implement")){
          ...
          /*  linBookingPic.setVisibility(View.VISIBLE);
            linAadharPicOne.setVisibility(View.VISIBLE);
            linAdharPicTwo.setVisibility(View.VISIBLE);
            linElectionCardOne.setVisibility(View.VISIBLE);
            linElectionCardTwo.setVisibility(View.VISIBLE);
            linPassportSizeOne.setVisibility(View.VISIBLE);
            linPassportSizeTwo.setVisibility(View.VISIBLE);*/
        }
        ...
        edt_AddCD_Pickdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(AddCustomerDetailsDealstageActivity.this,
              ...
              //  Toast.makeText(AddCustomerDetailsActivity.this, ""+getNum, Toast.LENGTH_SHORT).show();
                ...
                WebService.getClient().getDetailsOnMobileNo(getNum).enqueue(new Callback<MobileNumDetailModel>() {
                    ...
                    public void onFailure(@NotNull Call<MobileNumDetailModel> call, @NotNull Throwable t) {
                        // progressDialog.dismiss();
                        Toast.makeText(AddCustomerDetailsDealstageActivity.this, "" + t.getCause(), Toast.LENGTH_SHORT).show();
                    }
                });
      ...
      /*  txt_AddCD_BankPassBook.setOnClickListener(new View.OnClickListener() {
        ...
        btn_AddCD_Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValidate()) {
                    progressDialog = new ProgressDialog(AddCustomerDetailsDealstageActivity.this);
                    progressDialog.show();
                    progressDialog.setContentView(R.layout.progress_dialog);
                    progressDialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
              ...
              /*  if(waypathPassBook != null){
                ...
                if(waypathCheque != null){
                    ...
                    WebService.getClient().getCustomerDetailNext(
                            ...
                            RequestBody.create(MediaType.parse("text/plain"), edt_AddCD_Surname.getText().toString()),
                            RequestBody.create(MediaType.parse("text/plain"), edt_AddCD_MobileNo.getText().toString()),
                       ...
                       /* imagePassBook,
                        ...
                        sharedPreferences.edit().putString("NextId", String.valueOf(response.body().getId())).apply();*/
                            ...
                            Toast.makeText(AddCustomerDetailsDealstageActivity.this, "" + response.body().getMsg(), Toast.LENGTH_LONG).show();

                            if (Product_Name.equals("Other")) {
                                Intent i = new Intent(AddCustomerDetailsDealstageActivity.this,
                                        DealfirstMeetingActivityViewINQ.class);
                                /* i.putExtra("nextId",nextId);*/
                                startActivity(i);
                            } else {
                                Intent i = new Intent(AddCustomerDetailsDealstageActivity.this, DownPaymentDealstageActivity.class);
                                /* i.putExtra("nextId",nextId);*/
                                startActivity(i);
                            }

                            // Intent i = new Intent(AddCustomerDetailsActivity.this, ProductDetailsActivity.class);
                            //  Intent i = new Intent(AddCustomerDetailsActivity.this, RtoDetailsActivity.class);
    ...
    private boolean isValidate() {
        ...
        if ( edt_AddCD_Pickdate.getText().toString().trim().equals("")) {
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please select date");
            return false;
        }else if (edt_AddCD_MobileNo.getText().toString().trim().equals("")) {
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please enter Mobile No.");
            return false;
        }else if (edt_AddCD_WhatsappNo.getText().toString().equals("")){
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please enter Whatsapp No.");
            return false;
        }else if (edt_AddCD_State.getText().toString().equals("")){
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please enter State");
            return false;
        }else if (edt_AddCD_City.getText().toString().equals("")){
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please enter City");
            return false;
        }else if (edt_AddCD_District.getText().toString().equals("")){
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please enter District");
            return false;
        }else if (edt_AddCD_Taluko.getText().toString().equals("")){
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please enter Taluko");
            return false;
        }else if (edt_AddCD_Village.getText().toString().equals("")){
            Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Please enter Village name");
            return false;
        }else if (spn_AddCD_Payment.getVisibility()==View.VISIBLE){
            if(spn_AddCD_Payment.getSelectedItem().toString().trim().equals("Payment")) {
                Utils.showErrorToast(AddCustomerDetailsDealstageActivity.this, "Select Payment");
                return false;
            }
        }else{
            return true;
