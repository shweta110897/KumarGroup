...
public class DealfirstMeetingActivityViewINQ extends AppCompatActivity {
    ...
    String modelname="", Category, cat_id, sname, emp_id, MobileNo, Vemp;
    ...
    String waypathPhoto_book, waypathPhoto_deli,mobile,login_emp="",empname="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        empname = sharedPreferencesS.getString("Slected_EMPNAME","");
        ...
        Log.d("TAG", "onCreate: "+login_emp);
        progressDialog = new ProgressDialog(DealfirstMeetingActivityViewINQ.this);
                ...
                */
                if (chcekedit.equals("edtBookAmountVI")) {
                    if (TextUtils.isEmpty(bktamt)) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please Select Booking in Amount ");
                        return;
                    }
                } else if (chcekedit.equals("edtModelNameVI")) {
                    if (TextUtils.isEmpty(modelname)) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please Select Delivery in Model name ");
                        return;
                    }
                } else if (chcekedit.equals("edtSellLostVI")) {
                    if (TextUtils.isEmpty(selllost)) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please Select selllost in details ");
                        return;
                    }
                } else if (chcekedit.equals("edtdropen")) {
                    if (TextUtils.isEmpty(dropdes)) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please Select dropdes in Description ");
                        return;
                    }
                } else {
                    Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please Select anyone type");
                    return;
                }
...
//                loan dpclear oldrcbook
                    if (TextUtils.isEmpty(loan)) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please select Loan Clear");
                        return;
                    }

                    if (TextUtils.isEmpty(dpclear)) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please select D.P clear");
                        return;
                    }

                    if (TextUtils.isEmpty(oldrcbook)) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please select Old RC Book & Vehicle");
                        return;
                    }
                }
                ...
                if (booking_falg) {
                    if (waypathPhoto_book == null) {
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "Please upload Photo");
                        return;
                    }
                    else {
...
//                    login_emp = "";
                ...
                WebService.getClient().deal_first_meeting_web(
                    ...
                    public void onResponse(Call<Deal_model> call, Response<Deal_model> response) {
                        ...
                        Toast.makeText(DealfirstMeetingActivityViewINQ.this, ""+response.body().getMsg(), Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(DealfirstMeetingActivityViewINQ.this, DealViewMainActivity.class)
                    ...
                    public void onFailure(Call<Deal_model> call, Throwable t) {
                        progressDialog.dismiss();
                        Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this, "errrr"+t.getMessage());
                    }
                });
            }
        });
    ...
    private void ModelNameGetMethod() {
        WebService.getClient().getModel_firstmeeting().enqueue(new Callback<getModelData>() {
            ...
            public void onResponse(Call<getModelData> call, Response<getModelData> response) {
                ...
                {
                    Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this,"No Data Found");
                }
                else {
                    ...
                    ArrayAdapter spndropen_array = new ArrayAdapter(DealfirstMeetingActivityViewINQ.this, android.R.layout.simple_spinner_dropdown_item, modellist);
            ...
            public void onFailure(Call<getModelData> call, Throwable t) {
                Utils.showErrorToast(DealfirstMeetingActivityViewINQ.this,t.getMessage());
            }
        });
    }
