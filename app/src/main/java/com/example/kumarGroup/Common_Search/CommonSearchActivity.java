...
public class CommonSearchActivity extends AppCompatActivity {
    ...
    EditText editText_common_search;
    Button button_search;
    String emp_id,cat_id,Paymenttype,Passingtype;
...
//        Log.d("TAG", "onClick: Else "+emp_id+" Cat id "+cat_id+" Number "+editText_common_search.getText());
        WebService.getClient().CommonSearch(emp_id,cat_id,Paymenttype,Passingtype).enqueue(new Callback<CommonSearch>() {
            @Override
            public void onResponse(Call<CommonSearch> call, Response<CommonSearch> response) {
                    pro.dismiss();
                    recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                    commonSearchAdapter = new CommonSearchAdapter(CommonSearchActivity.this/*,CommonSearchActivity.this*/,response.body().getCat());
    ...
    private void showDialogPayment() {
        Dialog dialog = new Dialog(CommonSearchActivity.this);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
               /* Intent intent = new Intent(CommonSearchActivity.this, CommonSearchActivity.class);
                intent.putExtra("Paymenttype",Paymenttype);
                startActivity(intent);*/
