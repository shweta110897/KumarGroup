...
public class MornigFourAlarm extends BroadcastReceiver {
...
//        v.vibrate(20000);
       ...
       /* PendingIntent pendingIntent = PendingIntent.getActivity(context, 0,
        ...
        NotificationCompat.Builder mNotifyBuilder = new NotificationCompat.Builder(
                ...
                .setContentText("Morning Four Alarm").setSound(alarmSound)
                //.setContentText("Check In Time")
                .setAutoCancel(true).setWhen(when)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher))
                .setStyle(new NotificationCompat.BigTextStyle().bigText("Morning Four Alarm"))
