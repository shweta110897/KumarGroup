...
import com.example.kumarGroup.ChackOut;
...
//        if (Objects.equals(intent.getAction(), "android.intent.action.BOOT_COMPLETED")) {
            ...
            stackBuilder.addParentStack(ChackOut.class);
...
//            PendingIntent pendingIntent = stackBuilder.getPendingIntent(0, PendingIntent.FLAG_UPDATE_CURRENT);//getting the pendingIntent
            ...
            Notification notification = builder.setContentTitle("Check OUT Notification")
