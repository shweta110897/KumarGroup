...
public class MornigFirstAlarm extends BroadcastReceiver {
...
//        v.vibrate(20000);
        ...
        NotificationCompat.Builder mNotifyBuilder = new NotificationCompat.Builder(
                ...
                .setContentText("Morning First Alarm").setSound(alarmSound)
                //.setContentText("Check In Time")
                .setAutoCancel(true).setWhen(when)
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher))
                .setStyle(new NotificationCompat.BigTextStyle().bigText("Morning First Alarm"))
