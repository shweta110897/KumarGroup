...
public class MonthlyInqDataDisplayAdapter_one extends RecyclerView.Adapter<MonthlyInqDataDisplayAdapter_one.ViewHolder>
    implements Filterable
{
    Context context;
    List<CatInq> catAllEntryMWDS;
    List<CatInq> catAllEntryMWDS_one;
    ...
    public MonthlyInqDataDisplayAdapter_one(Context context, Activity activity,List<CatInq> catAllEntryMWDS) {
    ...
    @NonNull
    @Override
    public MonthlyInqDataDisplayAdapter_one.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View listItem = inflater.inflate(R.layout.design_visit, parent, false);
        MonthlyInqDataDisplayAdapter_one.ViewHolder viewHolder = new MonthlyInqDataDisplayAdapter_one.ViewHolder(listItem);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull MonthlyInqDataDisplayAdapter_one.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<CatInq> filteredList = new ArrayList<>();

                    for (CatInq row : catAllEntryMWDS_one) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                catAllEntryMWDS = (ArrayList<CatInq>) filterResults.values;
