...
import com.example.kumarGroup.BookingDeliveryUpload.PaymentPending.PaymentPendingDocAdapter;
...
public class WalletPaymentCollection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wallet_payment_collection);
        ...
        progressDialog= new ProgressDialog(WalletPaymentCollection.this);
        progressDialog.show();
        progressDialog.setContentView(R.layout.progress_dialog);
        progressDialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);


        WebService.getClient().getWalletPaymentPending(emp).enqueue(new Callback<PaymentPendingModel>() {
            @Override
            public void onResponse(@NotNull Call<PaymentPendingModel> call, @NotNull Response<PaymentPendingModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (catShow.size() == 0) {
                        Utils.showErrorToast(WalletPaymentCollection.this,"No Data Found");
                        getSupportActionBar().setTitle("Total:-"+tot1);
...
//                                }
                        ...
                        getSupportActionBar().setTitle("Total: "+tot1);
                        showDetailAdapter = new PaymentPendingDocAdapter(WalletPaymentCollection.this,
                                catShow,idPayment);
...
//
                    ...
                    Utils.showNormalToast(WalletPaymentCollection.this,"Data Not Found");
                }
            ...
            public void onFailure(@NotNull Call<PaymentPendingModel> call, @NotNull Throwable t) {
                ...
                Utils.showErrorToast(WalletPaymentCollection.this,"No Data Available");
            }
        });
