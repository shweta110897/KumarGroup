...
public class AllEntryMonthWeekDayActivity extends AppCompatActivity {
    ...
    SwipeRefreshLayout swipeRefreshLayoutWeekDay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_entry_month_week_day);

        rclvAllEntryMonthWeekDay=findViewById(R.id.rclvAllEntryMonthWeekDay);
        swipeRefreshLayoutWeekDay=findViewById(R.id.swipeRefreshLayoutWeekDay);
        ...
        progressDialog= new ProgressDialog(AllEntryMonthWeekDayActivity.this);
        progressDialog.show();
              ...
              //  DisplayMonthAdapter adpater1 = new DisplayMonthAdapter(ShowMonthlyFUActivity.this,response.body().getCat());
               // rclvDisplayMonth.setAdapter(adpater1);
                AllEntryMonthWeekDayAdapter allEntryMonthWeekDayAdapter = new
                        AllEntryMonthWeekDayAdapter(AllEntryMonthWeekDayActivity.this,
        ...
        swipeRefreshLayoutWeekDay.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                WebService.getClient().getAllEntryMWD(id).enqueue(new Callback<AllEntryMonthWeekDayRCModel>() {
                    ...
                    public void onResponse(@NotNull Call<AllEntryMonthWeekDayRCModel> call,
                        ...
                        swipeRefreshLayoutWeekDay.setRefreshing(false);
                        getLastNumber();
