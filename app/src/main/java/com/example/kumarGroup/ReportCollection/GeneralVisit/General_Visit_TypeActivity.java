...
public class General_Visit_TypeActivity extends AppCompatActivity {
    ...
    public static boolean Type_General_Check = false;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_general_visit_type);
        ...
        spn_village_type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (village_type.equals("Booking Delivery")){
                    Type_General_Check = true;

                }else {
                    Type_General_Check = false;
        ...
        btn_Next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (village_type.equals("Select Option")){
                    ...
                    Intent intent = new Intent(General_Visit_TypeActivity.this, Type_Count_Activity.class);
