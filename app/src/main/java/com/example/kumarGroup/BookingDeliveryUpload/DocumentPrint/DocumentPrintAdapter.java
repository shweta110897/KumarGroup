...
import com.example.kumarGroup.DataDocPrint;
import com.example.kumarGroup.R;

import java.util.List;

public class DocumentPrintAdapter extends RecyclerView.Adapter<DocumentPrintAdapter.ViewHolder> {

    Context context;
    List<DataDocPrint>  dataDocPrints;

    public DocumentPrintAdapter(Context context, List<DataDocPrint> dataDocPrints) {
        this.context = context;
        this.dataDocPrints = dataDocPrints;
    }
    ...
    @NonNull
    @Override
    public DocumentPrintAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View listItem = inflater.inflate(R.layout.booking_main_raw, parent, false);
        DocumentPrintAdapter.ViewHolder viewHolder = new DocumentPrintAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull DocumentPrintAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.tv_name_booking.setText("Name: "+dataDocPrints.get(position).getFname()+" "+dataDocPrints.get(position).getLname());
        holder.tv_mobile_no_booking.setText("Mobile No: "+dataDocPrints.get(position).getMobileno());
        holder.tv_Wta_Number_booking.setText("WhatsApp no: "+dataDocPrints.get(position).getWhno());
        holder.tv_village_booking.setText("Village: "+dataDocPrints.get(position).getVillage());
        holder.tv_description_booking.setText("Description: "+dataDocPrints.get(position).getDescription());
        holder.tv_Type.setText("Type: "+dataDocPrints.get(position).getB_type());
        holder.tv_Employee_name.setText("Employee Name: "+dataDocPrints.get(position).getEmp());
        if (dataDocPrints.get(position).getRto()==null){
            holder.tv_Rto.setText("RTO: ");
        }else {
            holder.tv_Rto.setText("RTO: "+dataDocPrints.get(position).getRto());
        }
        if (dataDocPrints.get(position).getCskim()==null){
            holder.tv_consumer_scheme.setText("Consumer Scheme: ");
        }else {
            holder.tv_consumer_scheme.setText("Consumer Scheme: "+dataDocPrints.get(position).getCskim());
        }
        if (dataDocPrints.get(position).getDmodelname()==null){
            holder.tv_model_name.setText("Model Name: ");
        }else {
            holder.tv_model_name.setText("Model Name: "+dataDocPrints.get(position).getDmodelname());
        }
        ...
        holder.linBookingUploadMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, DocumentPrintFormActivity.class);
                i.putExtra("idBookingUpload", dataDocPrints.get(position).getId());
        ...
        holder.lin_BookingMain_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:"+dataDocPrints.get(position).getMobileno()));
                Log.d("call", "onClick: "+dataDocPrints.get(position).getMobileno());
        ...
        holder.lin_BookingMain_sms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent smsIntent = new Intent(Intent.ACTION_VIEW, Uri.fromParts("sms",
                        dataDocPrints.get(position).getMobileno(), null));
            ...
            public void onClick(View v) {
                ...
                if (installed){
                    ...
                    intent.setData(Uri.parse("http://api.whatsapp.com/send?phone="+"+91"+
                            dataDocPrints.get(position).getWhno()));
                    context.startActivity(intent);
                }else {
        ...
        holder.lin_BookingMain_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra(android.content.Intent.EXTRA_TEXT,  "** Kumar Group ** \n" +
                        ""+"Customer Detail:\n" +
                        "Name: "+dataDocPrints.get(position).getFname()+" "+
                        dataDocPrints.get(position).getLname()+"\n" +
                        "Employee Name: "+dataDocPrints.get(position).getEmp()+"\n" +
                        "Mobile: "+dataDocPrints.get(position).getMobileno()+"\n"+
                        "WhatsApp Number: "+dataDocPrints.get(position).getWhno()+"\n"+
                        "Description: "+dataDocPrints.get(position).getDescription()+"\n");
