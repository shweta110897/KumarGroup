...
public class BookingUploadMainAdapter extends RecyclerView.Adapter<BookingUploadMainAdapter.ViewHolder>{
    ...
    public BookingUploadMainAdapter(Context activity, Context context, List<DataBooking> dataBookings) {
    ...
    @NonNull
    @Override
    public BookingUploadMainAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View listItem = inflater.inflate(R.layout.booking_main_raw, parent, false);
        BookingUploadMainAdapter.ViewHolder viewHolder = new BookingUploadMainAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull BookingUploadMainAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
