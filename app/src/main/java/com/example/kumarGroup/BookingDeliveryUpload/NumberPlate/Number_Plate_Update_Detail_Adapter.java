...
public class Number_Plate_Update_Detail_Adapter extends RecyclerView.Adapter<Number_Plate_Update_Detail_Adapter.ViewHolder>  implements Filterable {

    NumberPlate_Detail_Activity activity;
    Context context;
    List<com.example.kumarGroup.RcUpdate.rcUpdate> data;
    List<com.example.kumarGroup.RcUpdate.rcUpdate> data_one;
    String sms= "";

    public Number_Plate_Update_Detail_Adapter(NumberPlate_Detail_Activity activity, Context context, List<com.example.kumarGroup.RcUpdate.rcUpdate> data) {
    ...
    @NonNull
    @Override
    public Number_Plate_Update_Detail_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.booking_main_raw,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Number_Plate_Update_Detail_Adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        String receive_fitment_flag=data.get(position).getLevel_fitment_approve();
        if (receive_fitment_flag.equals("0")){
            holder.linBookingUploadMain.setEnabled(false);
            holder.lin_MDY_visit.setText("Pending");
            holder.lin_MDY_visit.setBackgroundColor(context.getResources().getColor(R.color.txt_red));
        }else if (receive_fitment_flag.equals("1")){
            holder.linBookingUploadMain.setEnabled(true);
            holder.lin_MDY_visit.setText("Approve");
            holder.lin_MDY_visit.setBackgroundColor(context.getResources().getColor(R.color.Green));
        }

        holder.linBookingUploadMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, NumberPlate_UpdateActivity.class);
