...
public class DeliveryMainAdapter extends RecyclerView.Adapter<DeliveryMainAdapter.ViewHolder>
{
    ...
    public DeliveryMainAdapter(Context context, List<DataDisplay> dataDisplays) {
    ...
    @NonNull
    @Override
    public DeliveryMainAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View listItem = inflater.inflate(R.layout.booking_main_raw, parent, false);
        DeliveryMainAdapter.ViewHolder viewHolder = new DeliveryMainAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull DeliveryMainAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
