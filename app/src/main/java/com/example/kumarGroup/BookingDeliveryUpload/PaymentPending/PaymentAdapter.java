...
import com.example.kumarGroup.CatPayment;
...
public class PaymentAdapter extends RecyclerView.Adapter<PaymentAdapter.ViewHolder> {
    ...
    public PaymentAdapter(Context context, List<CatPayment> payment_payPenModels) {
...
*/
        ...
        // sharedPreferences = activity.getSharedPreferences("TP_Payment", MODE_PRIVATE);
        // sharedPreferences.edit().putString("TP_Payment1", String.valueOf(payment_payPenModels.get(position).getTp())).apply();

        sharedPreferences.edit().putInt("TP_Payment1", payment_payPenModels.get(position).getTp()).apply();

       /* ArrayList<String> totalpayment = new ArrayList<>();

        for(int i =0 ; i<payment_payPenModels.size(); i++){
            totalpayment.add(String.valueOf(payment_payPenModels.get(position).getTp()));
        }*/

       // sharedPreferences.edit().putStringSet("TP_Payment2", totalpayment).apply();
        ...
        Set<String> set = new HashSet<String>();
        set.addAll(totalpayment);
        edit.putStringSet("PrefsKey", set);
        edit.apply();*/


        /*Add And retrieve data into sharedpreference */
