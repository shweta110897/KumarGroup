...
public class RC_Customer_Update_Detail_Adapter extends RecyclerView.Adapter<RC_Customer_Update_Detail_Adapter.ViewHolder>  implements Filterable {
    ...
    public RC_Customer_Update_Detail_Adapter(Context activity, Context context, List<com.example.kumarGroup.RcUpdate.rcUpdate> data) {
    ...
    @NonNull
    @Override
    public RC_Customer_Update_Detail_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.booking_main_raw,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RC_Customer_Update_Detail_Adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        String getRegister_no;
        if (data.get(position).getRegister_no()==null){
            getRegister_no="";
        }else{
            getRegister_no=data.get(position).getRegister_no();
        }
        ...
        holder.linBookingUploadMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, RC_Customer_UpdateActivity.class);
                i.putExtra("idBookingUpload", data.get(position).getId());
                i.putExtra("position",pos);
                i.putExtra("register_no",getRegister_no);
