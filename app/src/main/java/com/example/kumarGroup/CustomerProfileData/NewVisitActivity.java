...
public class NewVisitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(NewVisitActivity.this);
        progressDialog.show();
        ...
        WebService.getClient().getViewCuProfileEdit(MobileNo).enqueue(new Callback<ViewCustomerProfileEditModel>() {
            ...
            public void onResponse(@NotNull Call<ViewCustomerProfileEditModel> call,
                ...
                if (response.body().getCustomer_profile().size() == 0) {
                    Utils.showErrorToast(NewVisitActivity.this, "No Data Available");
            ...
            public void onResponse(Call<DatabankMakeModel> call, Response<DatabankMakeModel> response1) {
                ...
                if (response1.isSuccessful()) {
                    if (response1.body() != null) {
                        ...
                        ArrayAdapter adapter2 = new ArrayAdapter(NewVisitActivity.this,
                                        ...
                                        public void onResponse(Call<DatabankModelListModel> call, Response<DatabankModelListModel> response2) {
                                            ...
                                            if (response2.isSuccessful()) {
                                                if (response2.body() != null) {
                                                    ...
                                                    ArrayAdapter adapter3 = new ArrayAdapter(NewVisitActivity.this,
...
//                            if (strModel!=null  || !strModel.equals("")){
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(NewVisitActivity.this, TractorDoIt.class);
                startActivity(i);
            }
        });
        ...
        btn_Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isvalidate()){
                    ...
                    WebService.getClient().getNewVisitEntryList(
                            emp,
...
//                                                String toNumber = "+917500567770";
                            ...
                            if (response.body().getMsg().equals("already Reason Update")){
                                Toast.makeText(NewVisitActivity.this, "" + response.body().getMsg(), Toast.LENGTH_LONG).show();
                            }else{
                                finish();
