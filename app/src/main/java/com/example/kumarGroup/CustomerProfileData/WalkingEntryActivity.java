...
import com.example.kumarGroup.CustomerProfileEdit;
...
public class WalkingEntryActivity extends AppCompatActivity {
    ...
    Button btn_Submit;
    List<CustomerProfileEdit>  customerProfileEdits;
    ...
    Spinner sp_make_name ,sp_model_name,sp_category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_waling_entry);
        ...
        progressDialog = new ProgressDialog(WalkingEntryActivity.this);
        progressDialog.show();
        ...
        WebService.getClient().getViewCuProfileEdit(MobileNo).enqueue(new Callback<ViewCustomerProfileEditModel>() {
            ...
            public void onResponse(@NotNull Call<ViewCustomerProfileEditModel> call,
                ...
                customerProfileEdits=response.body().getCustomer_profile();
                if (customerProfileEdits.size() == 0) {
                    Utils.showErrorToast(WalkingEntryActivity.this, "No Data Available");
                    ll_main.setVisibility(View.GONE);
                    btn_add.setVisibility(View.VISIBLE);

                    setMenuVisible(false,R.id.action_add);
                } else {

                    ll_main.setVisibility(View.VISIBLE);
                    btn_add.setVisibility(View.GONE);
                    setMenuVisible(true,R.id.action_add);
                    edt_categoryName.setText(customerProfileEdits.get(0).getCat_name());
                    edt_FnameName.setText(customerProfileEdits.get(0).getFname());
                    edt_LastName.setText(customerProfileEdits.get(0).getLname());
                    edt_mobile_number.setText(customerProfileEdits.get(0).getMoblino());
                    edt_whatsapp_number.setText(customerProfileEdits.get(0).getWhatsappno());
                    edt_State.setText(customerProfileEdits.get(0).getState());
                    edt_City.setText(customerProfileEdits.get(0).getCity());
                    edt_District.setText(customerProfileEdits.get(0).getDistric());
                    edt_Taluko.setText(customerProfileEdits.get(0).getTehsil());
                    edt_Village.setText(customerProfileEdits.get(0).getVilage());


                    cuid = customerProfileEdits.get(0).getId();
                }
            ...
            public void onResponse(Call<DatabankMakeModel> call, Response<DatabankMakeModel> response1) {
                ...
                if (response1.isSuccessful()) {
                    if (response1.body() != null) {
                        ...
                        ArrayAdapter adapter2 = new ArrayAdapter(WalkingEntryActivity.this,
                                        ...
                                        public void onResponse(Call<DatabankModelListModel> call, Response<DatabankModelListModel> response2) {
                                            ...
                                            if (response2.isSuccessful()) {
                                                if (response2.body() != null) {
                                                    ...
                                                    ArrayAdapter adapter3 = new ArrayAdapter(WalkingEntryActivity.this,
...
//                            if (strModel!=null  || !strModel.equals("")){
                    ...
                    if (response.body() != null) {
                        ...
                        tv_inquiry.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(WalkingEntryActivity.this);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WalkingEntryActivity.this, TractorDoIt.class);
                startActivity(i);
            }
        });
        ...
        btn_Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isvalidate()) {
                    ...
                    WebService.getClient().getWalkingEntryList(
                            emp,
...
//                                                String toNumber = "+917500567770";
                            ...
                            if (response.body().getMsg().equals("already Reason Update")){
                                Toast.makeText(WalkingEntryActivity.this, "" + response.body().getMsg(), Toast.LENGTH_LONG).show();
                            }else{
                                finish();
