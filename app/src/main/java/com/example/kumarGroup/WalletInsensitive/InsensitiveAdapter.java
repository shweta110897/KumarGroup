...
public class InsensitiveAdapter extends RecyclerView.Adapter<InsensitiveAdapter.ViewHolder>
{
    Context context;
    ...
    public InsensitiveAdapter(Context context, List<DataInsensitive> dataInsensitiveList) {
    ...
    @NonNull
    @Override
    public InsensitiveAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View listItem = inflater.inflate(R.layout.insensitive_raw, parent, false);
        InsensitiveAdapter.ViewHolder viewHolder = new InsensitiveAdapter.ViewHolder(listItem);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull InsensitiveAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//       Log.d("final_amounttt",dataInsensitiveList.get(position).getFinal_amount());
...
//            Utils.showErrorToast(context,"Account is not created yet !");
