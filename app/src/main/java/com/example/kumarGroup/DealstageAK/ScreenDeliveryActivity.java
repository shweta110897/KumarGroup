...
public class ScreenDeliveryActivity extends AppCompatActivity {
    String id,sname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_screen_delivery);
        ...
        WebService.getClient().getdeliveryScreen_web(id,sname).enqueue(new Callback<delivery_screen_model>() {
            ...
            public void onFailure(Call<delivery_screen_model> call, Throwable t) {
                Utils.showErrorToast(ScreenDeliveryActivity.this,t.getMessage());
                pro.dismiss();
            }
        });
    }
