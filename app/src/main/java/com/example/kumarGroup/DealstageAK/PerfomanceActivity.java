...
public class PerfomanceActivity extends AppCompatActivity {
    ...
    String emp="",empname="",date1,date2,emp12="",StateId="",StateIdName;
    TextView trdataentry,trachivment,datanote,assign_count,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Performance Inquiry");

//        SharedPreferences sharedPreferencesS = getSharedPreferences("Login",MODE_PRIVATE);
//        emp = sharedPreferencesS.getString("emp_id","");

        SharedPreferences sp1 = getSharedPreferences("ScoreBoardId", MODE_PRIVATE);
        StateId=sp1.getString("StateId","");
        StateIdName=sp1.getString("StateIdName","");

        SharedPreferences sp = getSharedPreferences("Login", MODE_PRIVATE);

        emp=sp.getString("emp_name","");
        emp12 = sp.getString("emp_id","");
        ...
        if (empname.equals("Select Employee")){
            tv_performance1.setText(emp+" "+date1+" to "+date2);
        }else{
            tv_performance1.setText(emp+" "+date1+" to "+date2);
        }
        ...
        btn_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    Log.d("device==>>q",">q");
                    Toast.makeText(PerfomanceActivity.this, "iffff", Toast.LENGTH_SHORT).show();
                    ...
                    Uri imageUri = FileProvider.getUriForFile(PerfomanceActivity.this, getPackageName() + ".provider", cachePath);
                  ...
                  /*  shareIntent.setPackage("com.whatsapp");*/
                    ...
                    Log.d("device==>>q","<q");
                    Toast.makeText(PerfomanceActivity.this, "elseee", Toast.LENGTH_SHORT).show();
...
//            }
     ...
     /*   WebService.getClient().getWalletPaymentPending(emp12).enqueue(new Callback<PaymentPendingModel>() {
            @Override
            public void onResponse(@NotNull Call<PaymentPendingModel> call, @NotNull Response<PaymentPendingModel> response) {

                if (response.isSuccessful()) {
                    if (response.body().getData().size() == 0) {
                        Utils.showErrorToast(PerfomanceActivity.this,"No Data Found");
...
//                                }
                    ...
                    Utils.showNormalToast(PerfomanceActivity.this,"Data Not Found");
                }
            ...
            public void onFailure(@NotNull Call<PaymentPendingModel> call, @NotNull Throwable t) {
                ...
                Utils.showErrorToast(PerfomanceActivity.this,"No Data Available");
            }
        });
*/

        WebService.getClient().getInsensitiveDeliveryData(emp12).enqueue(new Callback<InsentiveWalletModel>() {
            @Override
        ...
        WebService.getClient().getPerfomance(emp12,date1,date2/*,VillageId*/).enqueue(new Callback<perfomance_model>() {
            @Override
